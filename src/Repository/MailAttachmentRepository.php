...
/**
 * @extends ServiceEntityRepository<MailAttachment>
 *
...
class MailAttachmentRepository extends ServiceEntityRepository
{
    ...
    public function save(MailAttachment $entity, bool $flush = false): void
    {
    ...
    public function remove(MailAttachment $entity, bool $flush = false): void
    {
